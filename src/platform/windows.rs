use super::{PlatformDiskInfo, SmartStatus};
use std::process::Command;
use serde_json;

impl PlatformDiskInfo for super::WindowsPlatform {
    fn get_smart_status(&self, disk_name: &str, debug: bool) -> SmartStatus {
        get_smart_status_impl(disk_name, debug)
    }
...
fn get_smart_status_impl(disk_name: &str, debug: bool) -> SmartStatus {
    if debug {
